...
function Profile() {
    ...
    return (
        user && (
            <>
                <div className="w-full min-h-fit h-[416px] relative bg-gray-300 z-0">
                ...
                <button
                    className={classNames(
                        "z-50 absolute right-[80px] top-[420px] h-12 w-12 text-white bg-blue-500 hover:bg-blue-600 hover:cursor-pointer font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center min-w-[140px] w-1/5 justify-center lg:top-[440px] lg:right-[160px]"
                    )}
                    type="button"
                    ...
                    <div className="mt-4 grid grid-cols-2 place-content-evenly place-items-center gap-x-8 gap-y-4 border-t border-gray-200 p-9 pt-2 lg:grid-cols-3 bg-gray-200">
                        {myposts && myposts.map((post) => (
                            <a key={post.id} href={`/posts/${post.id}`}>
                                <article
                                    key={post.id}
                                    className="flex-start delay-50 relative flex h-[28rem] max-w-xl flex-col rounded-xl bg-teal-50 p-2 shadow-xl transition ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-teal-300 md:h-[32rem]"
                                >
                                    <div className="relative h-[300px] w-[250px] sm:w-[280px] md:w-[340px] lg:w-[300px] xl:w-[400px]">
                                        <img alt="" className="h-[300px] w-full object-cover rounded-lg grayscale-[35%]" src={post.post_images[0].url} />
                                    </div>
                                    ...
                                    <div className="relative h-full">
                                        ...
                                        <div className="absolute top-1/2 flex h-3/6 w-full justify-center px-4 text-gray-700">
                                            <span className="text-clip w-full h-full text-center text-sm font-black md:text-xl">
