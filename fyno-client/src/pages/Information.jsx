...
const stats = [
    ...
    { name: '動保不是科目 是一個生活的態度', value: '讓孩子們從小培養這個素養，以後養動物的態度就會不一樣', src: Turtle },
    { name: '期待動保教育 傳承新的未來', value: '動保的觀念，從大人開始，一代一代將新的觀念傳承下去', src: dog },
    { name: '視貓狗為家人，謹慎面對送養', value: '透過FYNO，幫浪浪找到真正的final home!', src: dog3 },
]
    ...
    return (
        <div className="relative isolate overflow-hidden bg-emerald-300/[.2] py-24 sm:py-32">
            ...
            <div className="bg-white">
                <iframe className="absolute right-8 top-24" width="500" height="280" src="https://www.youtube.com/embed/rw6F9MvOwKI?autoplay=1" title="YouTube video player"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto lg:mx-0">
                    ...
                    <p className="mt-10 text-lg max-w-xl leading-8 text-black font-bold">
                        <span>全球每年有數百萬隻流浪動物面臨無家可歸的困境</span>
                        <br></br>
                        <span>這些數量巨大的流浪動物對於社會和環境都帶來了壓力。</span>
                    </p>
                    ...
                    <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
                        {stats.map((stat) => (
                            <div key={stat.name} className="rounded-xl shadow-xl transition-transform duration-500 transform group hover:rotate-y-12">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center rounded-xl bg-white opacity-0 hover:bg-indigo-200 hover:opacity-90 transform rotate-y-180 text-center">
