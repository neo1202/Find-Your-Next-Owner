...
const ShowEditButton = ({isEditing, setIsEditing, onProfileUpdate}) => {
  ...
  const handleHidden = (e) => {
	...
	return (
		<div className="z-50 absolute right-[80px] top-[360px] h-12 w-12 text-white bg-blue-500 hover:bg-blue-600 hover:cursor-pointer font-medium rounded-lg text-sm px-5 py-2.5 inline-flex items-center min-w-[140px] w-1/5 justify-center lg:top-[380px] lg:right-[160px]">
			{!isEditing && 
				<button
